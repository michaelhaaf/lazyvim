-- Adapted from: ~/github/dotfiles-latest/neovim/neobean/lua/plugins/luasnip.lua
...
return {
  ...
  opts = function(_, opts)
    ...
    table.insert(
      snippets,
      s({
        trig = "lecturetemplate",
        name = "Insert lecture template",
        desc = "Insert lecture template with frontmatter and sections",
      }, {
        t({ "---", "title: " }),
        i(1, ""),
        t({ "", "description: " }),
